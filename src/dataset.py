...
class SegDataset(Dataset):
    def __init__(self, 
        ...
        if self.transform is None:
            ...
            self.mask_transform = transforms.Compose([TF.to_tensor,
                                                 transforms.Resize(size=(self.img_h//4, self.img_w//4))])
    ...
    def __getitem__(self, index):
        ...
        v = (mask>127).type(torch.LongTensor)
        return image, (mask>127).type(torch.LongTensor)
